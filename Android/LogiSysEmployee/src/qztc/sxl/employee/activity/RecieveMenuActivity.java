...
public class RecieveMenuActivity extends MenuActivity {

	private static final String TAG = "RecieveMenuActivity";
	Intent intent;
	...
	*/
	...
	protected void bindEvent() {
		...
		btn_set.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				edt.setText(Constant.Recieve.info);
		        ...
		        .setPositiveButton("保存",new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog,
							int which) {
						// TODO Auto-generated method stub
						Constant.Recieve.info=edt.getText().toString();
					}})
		...
		btn_scan.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(RecieveMenuActivity.this,CaptureActivity.class);
	...
	private void  checkWaybill(String scanResult){
		...
		String url=props.getProperty("connection.updatelog")+"?id="+id+"&des="+des+"&method="+new Short(LogisticsInfo.RECEIVED).toString();
				...
				new Response.Listener<String>(){
					...
					public void onResponse(String response) {
						...
						if(json.optBoolean("success")){
							new AlertDialog.Builder(context)
					        .setMessage(result)
					        .setPositiveButton("确认揽收",new DialogInterface.OnClickListener(){

								@Override
								public void onClick(DialogInterface dialog,
										int which) {
									// TODO Auto-generated method stub
									//Constant.Recieve.info = "【厦门市】厦门软件园已揽收。";
									updateLog(id,(short)-1,Constant.Recieve.info);
								}})
					        .setNegativeButton("关闭",null)
					        .show();
				    	...
				    	//Toast.makeText(RecieveMenuActivity.this,result , Toast.LENGTH_LONG).show();
					}},
	...
	private void updateLog(String id, Short tid,String info){
		...
		map.put("method",new Short(LogisticsInfo.RECEIVED).toString());  
		map.put("id", id);  
