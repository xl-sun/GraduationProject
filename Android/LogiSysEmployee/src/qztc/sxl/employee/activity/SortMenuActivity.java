...
public class SortMenuActivity extends MenuActivity {

	private static final String TAG = "SortMenuActivity";
	Intent intent;
	...
	*/
	...
	protected void bindEvent() {
		...
		btn_set.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				edt.setText(Constant.Sort.info);
		        ...
		        .setPositiveButton("保存",new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface dialog,
							int which) {
						// TODO Auto-generated method stub
						Constant.Sort.info=edt.getText().toString();
					}})
		...
		btn_scan.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(SortMenuActivity.this,CaptureActivity.class);
				...
				new Response.Listener<String>(){
					...
					public void onResponse(String response) {
						...
						if(json.optBoolean("success"))
							updateLog(id,(short)-1,Constant.Sort.info);
						else{
							new AlertDialog.Builder(context)
					        .setMessage(result)
	...
	private void updateLog(String id, Short tid,String info){
		...
		map.put("method",new Short(LogisticsInfo.SORTED).toString());  
		map.put("id", id);  
