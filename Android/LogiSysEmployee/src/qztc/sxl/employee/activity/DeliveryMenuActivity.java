...
public class DeliveryMenuActivity extends MenuActivity {
	...
	*/
	...
	protected void bindEvent() {
		...
		btn_scan.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(DeliveryMenuActivity.this,CaptureActivity.class);
	...
	private void  checkWaybill(String scanResult){
		...
		String url=props.getProperty("connection.updatelog")+"?id="+id+"&method="+new Short(LogisticsInfo.DELIVRYING).toString();
	...
	private void updateLog(String id, Short tid,String info){
		...
		map.put("method",new Short(LogisticsInfo.DELIVRYING).toString());  
		map.put("id", id);  
	...
	/*
	private void  checkWaybill2(String scanResult){
		JSONObject json = null;
		try {
			json = new JSONObject(scanResult);
		} catch (JSONException e) {
		...
		final String des=json.optString("des");
		//Log.i(TAG,"checkWaybill 136");
		String url=props.getProperty("connection.updatelog")+"?id="+id+"&method="+new Short(LogisticsInfo.DELIVRYED).toString();
		RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
		//Log.i(TAG,"checkWaybill 141");
		StringRequestWithSession request = new StringRequestWithSession(Request.Method.GET,url,
				new Response.Listener<String>(){
